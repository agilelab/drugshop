...
namespace DrugShop.Entities
{
   ...
   [Serializable()]
   [Table("DS_SOUT","销售出库")]
   partial class SOut: DataEntity<SOut>, IDataEntity<SOut>
   {
       public SOut()
       {
       }
       
       protected SOut(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 出库数量 。
       /// </summary>
       [Column("NUMBER","出库数量"),DataSize(10)]
       [DisplayName("出库数量")]
       public int Number
       {
           get;
       ...
       /// 生产厂商 。
       /// </summary>
       [Column("PROVIDER","生产厂商"),DataSize(50)]
       [DisplayName("生产厂商")]
       ...
       /// 出库日期 。
       /// </summary>
       [Column("EventTime","出库日期"),DataSize(23,3)]
       [DisplayName("出库日期")]
       ...
       /// Customname 。
       /// </summary>
       [Column("CUSTOMNAME","Customname"),DataSize(64)]
