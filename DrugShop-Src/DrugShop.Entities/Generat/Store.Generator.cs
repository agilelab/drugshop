...
namespace DrugShop.Entities
{
   ...
   [Serializable()]
   [Table("DS_STORE","药品库存")]
   partial class Store: DataEntity<Store>, IDataEntity<Store>
   {
       public Store()
       {
       }
       
       protected Store(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 库存数量 。
       /// </summary>
       [Column("NUMBER","库存数量"),DataSize(10)]
       [DisplayName("库存数量")]
       public int Number
       {
           get;
       ...
       /// 库房编号 。
       /// </summary>
       [Column("BatchID","库房编号"),DataSize(64)]
       [DisplayName("库房编号")]
