...
namespace DrugShop.Entities
{
   ...
   [Serializable()]
   [Table("DS_LOST","药品报损")]
   partial class Lost: DataEntity<Lost>, IDataEntity<Lost>
   {
       public Lost()
       {
       }
       
       protected Lost(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 报损数量 。
       /// </summary>
       [Column("NUMBER","报损数量"),DataSize(10)]
       [DisplayName("报损数量")]
       public int Number
       {
           get;
       ...
       /// 报损日期 。
       /// </summary>
       [Column("EventTime","报损日期"),DataSize(23,3)]
       [DisplayName("报损日期")]
       ...
       /// 报损原因 。
       /// </summary>
       [Column("CAUSE","报损原因"),DataSize(128)]
       [DisplayName("报损原因")]
       public string Cause
       {
           get;
