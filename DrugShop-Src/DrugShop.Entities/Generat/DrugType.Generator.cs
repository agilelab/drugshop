...
namespace DrugShop.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("DS_DRUGTYPE","基础编码")]
   partial class DrugType: DataEntity<DrugType>, IDataEntity<DrugType>
   {
       public DrugType()
       {
       }
       
       protected DrugType(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 代码 。
       /// </summary>
       [Column("CODE","代码"),DataSize(10),PrimaryKey]
       [DisplayName("代码")]
       public int Code
       {
           get;
       ...
       /// 名称，这是相关国家标准确定的名称 。
       /// </summary>
       [Column("NAME","名称，这是相关国家标准确定的名称"),DataSize(64)]
       [DisplayName("名称，这是相关国家标准确定的名称")]
       public string Name
       {
           get;
           set;
       ...
       /// 输入码1 。
       /// </summary>
       [Column("InputCode1","输入码1"),DataSize(16)]
       [DisplayName("输入码1")]
       ...
       /// 简介，对代码的简短介绍 。
       /// </summary>
       [Column("DESCRIPTION","简介，对代码的简短介绍"),DataSize(512)]
       [DisplayName("简介，对代码的简短介绍")]
