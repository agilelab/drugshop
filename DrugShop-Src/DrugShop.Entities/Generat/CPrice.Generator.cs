...
namespace DrugShop.Entities
{
   ...
   /// </summary>
   [Serializable()]
   [Table("DS_CPRICE","药品调价")]
   partial class CPrice: DataEntity<CPrice>, IDataEntity<CPrice>
   {
       public CPrice()
       {
       }
       
       protected CPrice(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 销售价格（新） 。
       /// </summary>
       [Column("NSalePrice","销售价格（新）"),DataSize(18,4)]
       [DisplayName("销售价格（新）")]
       public decimal NSalePrice
       {
           get;
           set;
       }
       ...
       /// 调价数量  。
       /// </summary>
       [Column("NUMBER","调价数量 "),DataSize(10)]
       [DisplayName("调价数量 ")]
       public int Number
       {
           get;
       ...
       /// 批准文号 。
       /// </summary>
       [Column("FILENO","批准文号"),DataSize(32)]
       [DisplayName("批准文号")]
       ...
       /// 生产厂家 。
       /// </summary>
       [Column("PROVIDER","生产厂家"),DataSize(50)]
       [DisplayName("生产厂家")]
       ...
       /// 调价日期 。
       /// </summary>
       [Column("EventTime","调价日期"),DataSize(23,3)]
       [DisplayName("调价日期")]
       ...
       /// 调价原因 。
       /// </summary>
       [Column("CAUSE","调价原因"),DataSize(128)]
       [DisplayName("调价原因")]
       public string Cause
       {
           get;
