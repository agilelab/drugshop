...
namespace DrugShop.Entities
{
   ...
   [Serializable()]
   [Table("DS_PIN","采购入库")]
   partial class PIn: DataEntity<PIn>, IDataEntity<PIn>
   {
       public PIn()
       {
       }
       
       protected PIn(SerializationInfo info, StreamingContext context)
           : base(info, context)
       {
       }
       ...
       /// 批发价格 。
       /// </summary>
       [Column("JobPrice","批发价格"),DataSize(18,4)]
       [DisplayName("批发价格")]
       ...
       /// 入库数量 。
       /// </summary>
       [Column("NUMBER","入库数量"),DataSize(10)]
       [DisplayName("入库数量")]
       public int Number
       {
           get;
       ...
       /// 入库日期 。
       /// </summary>
       [Column("EventTime","入库日期"),DataSize(23,3)]
       [DisplayName("入库日期")]
